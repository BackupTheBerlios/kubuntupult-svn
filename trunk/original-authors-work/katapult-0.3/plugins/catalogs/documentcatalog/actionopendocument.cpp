...
int ActionOpenDocument::accepts(const KatapultItem* item) const
{
	return (qstrcmp(item->className(), "Document") == 0 || qstrcmp(item->className(), "Directory") == 0) ? 100 : 0;
}
...
{
	if(qstrcmp(item->className(), "Document") == 0 || qstrcmp(item->className(), "Directory") == 0) {
